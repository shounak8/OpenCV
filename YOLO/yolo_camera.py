...
# Activate the primary camera of system
capture_video = cv2.VideoCapture(0)

# Set parameters (note that product for both is 1920)
...
while True:
    # Read the camera capture frames
...
# classes = ["person", "car", "bus", "dog"]
# class_id_list = [0, 2, 6, 17]

# print(find_objects(outputs))
predicted_objects, bbox_locations, class_label_ids, conf_values = find_objects(outputs)
